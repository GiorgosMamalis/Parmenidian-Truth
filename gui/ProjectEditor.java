...
public class ProjectEditor extends JFrame {
	...
	private JLabel lblNewLabel_3, lblParmenidianProject, lblNewLabel, lblNewLabel_1, lblInput, lblOutput, lblNewLabel_2, lblNewLabel_4;
	private TextField textField_2, textField, textField_1, textField_3, textField_4;
	private JSeparator separator, separator_1;
	private Button button, button_1, button_3;
	...
	public ProjectEditor(final Gui parent, final String workspace, final boolean edit, String pn, String sql, String xml, String graphml, String tf,final String ini) {
		...
		addTextFields();
		addSeparators();
		addButtons(parent, workspace, edit, ini);
	...
	private void addLabels() {
		lblNewLabel_3 = new JLabel("Project name:");
		lblNewLabel_3.setBounds(20, 65, 84, 14);
		getContentPane().add(lblNewLabel_3);
		
		lblParmenidianProject = new JLabel("Parmenidian Project");
		...
		lblNewLabel = new JLabel("sql folder:");
		lblNewLabel.setBounds(20, 93, 84, 14);
		getContentPane().add(lblNewLabel);
		
		lblNewLabel_1 = new JLabel("Transition file:");
		...
		lblNewLabel_2 = new JLabel("Output folder:");
		lblNewLabel_2.setBounds(20, 215, 84, 14);
		getContentPane().add(lblNewLabel_2);
		
		lblNewLabel_4 = new JLabel("Graphml file:");
	...
	private void addButtons(final Gui parent, final String workspace, final boolean edit, final String ini) {
		button = new Button("...");
