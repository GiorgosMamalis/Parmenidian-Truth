...
public class GraphmlLoader {
	...
	public GraphmlLoader(String filename) throws FileNotFoundException {
		...
		Transformer<GraphMetadata, Graph<String, String>> graphTransformer = new Transformer<GraphMetadata, Graph<String, String>>() {
			public Graph<String, String> transform(GraphMetadata metadata) {
		...
		GraphMLReader2<Graph<String, String>, String, String> graphReader = new GraphMLReader2<Graph<String, String>, String, String> (fileReader, graphTransformer, vertexTransformer, edgeTransformer, hyperEdgeTransformer);
	 	try {
